...
if(registry.includes('shellDerivedFull')) failures.push('shellDerivedFull placeholder content cannot satisfy translation quality');
...
for(const broken of ['remainingFull','remainingFullB','remainingFullC','remainingFullD']) if(registry.includes(broken)) failures.push(`${broken}: corrupted historical bundle must not be imported by production registry`);
