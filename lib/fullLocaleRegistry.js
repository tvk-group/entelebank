...
import {recoveredFull} from './recoveredFull';
const full={tr:turkishFull,de:germanFull,fr:frenchFull,es:spanishFull,it:italianFull,pt:portugueseFull,nl:dutchFull,...recoveredFull};
